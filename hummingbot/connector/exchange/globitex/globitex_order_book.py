...
from hummingbot.connector.exchange.globitex.globitex_order_book_message import GlobitexOrderBookMessage

_logger = None


class GlobitexOrderBook(OrderBook):
    @classmethod
    ...
    def snapshot_message_from_exchange(cls, msg: Dict[str, any], timestamp: float, metadata: Optional[Dict] = None):
        ...
        return GlobitexOrderBookMessage(message_type=OrderBookMessageType.SNAPSHOT, content=msg, timestamp=timestamp)
    ...
    def snapshot_message_from_db(cls, record: RowProxy, metadata: Optional[Dict] = None):
        ...
        *used for backtesting
        ...
        """
        return GlobitexOrderBookMessage(
            message_type=OrderBookMessageType.SNAPSHOT, content=record.json, timestamp=record.timestamp
        )
    ...
    def diff_message_from_exchange(
        ...
        return GlobitexOrderBookMessage(message_type=OrderBookMessageType.DIFF, content=msg, timestamp=timestamp)
    ...
    def trade_message_from_exchange(
        ...
        return GlobitexOrderBookMessage(message_type=OrderBookMessageType.TRADE, content=msg, timestamp=timestamp)
    ...
    def trade_message_from_db(cls, record: RowProxy, metadata: Optional[Dict] = None):
        ...
        *used for backtesting
        ...
        """
        return GlobitexOrderBookMessage(
            message_type=OrderBookMessageType.TRADE, content=record.json, timestamp=record.timestamp
        )
