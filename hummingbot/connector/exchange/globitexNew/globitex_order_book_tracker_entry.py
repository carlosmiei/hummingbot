...
from hummingbot.connector.exchange.globitex.globitex_active_order_tracker import GlobitexActiveOrderTracker


class GlobitexOrderBookTrackerEntry(OrderBookTrackerEntry):
    def __init__(
        self, trading_pair: str, timestamp: float, order_book: OrderBook, active_order_tracker: GlobitexActiveOrderTracker
    ):
